...
if (quantity_int == 1) {
    ...
    license += "License key for " + name + " is " + makeHexLicenceKeyBeautiful(md5(licenseInitialString)) + "\n";
    ...
    for (var i = 0; i < quantity_int; i++) {
        ...
        license += "License key #" + (i + 1) + " for " + name + " is " + makeHexLicenceKeyBeautiful(md5(licenseInitialString)) + "\n";
